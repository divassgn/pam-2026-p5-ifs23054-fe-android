package org.delcom.pam_p5_ifs23054.network.todos.service

import okhttp3.MultipartBody
import org.delcom.pam_p5_ifs23054.helper.SuspendHelper
import org.delcom.pam_p5_ifs23054.network.data.ResponseMessage
import org.delcom.pam_p5_ifs23054.network.todos.data.RequestAuthLogin
import org.delcom.pam_p5_ifs23054.network.todos.data.RequestAuthLogout
import org.delcom.pam_p5_ifs23054.network.todos.data.RequestAuthRefreshToken
import org.delcom.pam_p5_ifs23054.network.todos.data.RequestAuthRegister
import org.delcom.pam_p5_ifs23054.network.todos.data.RequestTodo
import org.delcom.pam_p5_ifs23054.network.todos.data.RequestUserChange
import org.delcom.pam_p5_ifs23054.network.todos.data.RequestUserChangePassword
import org.delcom.pam_p5_ifs23054.network.todos.data.ResponseAuthLogin
import org.delcom.pam_p5_ifs23054.network.todos.data.ResponseAuthRegister
import org.delcom.pam_p5_ifs23054.network.todos.data.ResponseTodo
import org.delcom.pam_p5_ifs23054.network.todos.data.ResponseTodoStats
import org.delcom.pam_p5_ifs23054.network.todos.data.ResponseTodoAdd
import org.delcom.pam_p5_ifs23054.network.todos.data.ResponseTodos
import org.delcom.pam_p5_ifs23054.network.todos.data.ResponseUser
